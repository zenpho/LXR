...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ,	TEXT_SKIP,TEXT_PAT_SCALE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_TRANS1_WAVE,		PAR_TRANS1_VOL,			PAR_TRANS1_FREQ,		PAR_NONE,PAR_TRACK_SCALE,PAR_NONE,PAR_NONE,PAR_NONE	
	...
	//page 2 - Voice 2 - drum
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ,	TEXT_SKIP,TEXT_PAT_SCALE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_TRANS2_WAVE,		PAR_TRANS2_VOL,			PAR_TRANS2_FREQ,		PAR_NONE,PAR_TRACK_SCALE,PAR_NONE,PAR_NONE,PAR_NONE	
			//TEXT_FILTER_F,			TEXT_FILTER_TYPE,		TEXT_FILTER_RESO,	TEXT_FILTER_DRIVE,		
			//PAR_FILTER_FREQ_DRUM1,	PAR_FILTER_TYPE_DRUM1,	PAR_RESO_DRUM1,		PAR_FILTER_DRIVE_1,	
		},
		{
	...
	//page 3 - Voice 3 - drum
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ,	TEXT_SKIP,TEXT_PAT_SCALE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_TRANS3_WAVE,		PAR_TRANS3_VOL,			PAR_TRANS3_FREQ,		PAR_NONE,PAR_TRACK_SCALE,PAR_NONE,PAR_NONE,PAR_NONE	
			//TEXT_FILTER_F,			TEXT_FILTER_TYPE,		TEXT_FILTER_RESO,	TEXT_FILTER_DRIVE,		
			//PAR_FILTER_FREQ_DRUM1,	PAR_FILTER_TYPE_DRUM1,	PAR_RESO_DRUM1,		PAR_FILTER_DRIVE_1,	
		},
		{
	...
	//page 4 - Voice 4 - snare/clap
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ,	TEXT_SKIP,TEXT_PAT_SCALE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_TRANS4_WAVE,		PAR_TRANS4_VOL,			PAR_TRANS4_FREQ,		PAR_NONE,PAR_TRACK_SCALE,PAR_NONE,PAR_NONE,PAR_NONE	
			//TEXT_FILTER_F,			TEXT_FILTER_TYPE,		TEXT_FILTER_RESO,	TEXT_FILTER_DRIVE,		
			//PAR_FILTER_FREQ_DRUM1,	PAR_FILTER_TYPE_DRUM1,	PAR_RESO_DRUM1,		PAR_FILTER_DRIVE_1,	
		},
		//filter
	...
	//page 5 - Voice 5 - cymbal
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ,	TEXT_SKIP,TEXT_PAT_SCALE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_TRANS5_WAVE,		PAR_TRANS5_VOL,			PAR_TRANS5_FREQ,		PAR_NONE,PAR_TRACK_SCALE,PAR_NONE,PAR_NONE,PAR_NONE	
			//TEXT_FILTER_F,			TEXT_FILTER_TYPE,		TEXT_FILTER_RESO,	TEXT_FILTER_DRIVE,		
			//PAR_FILTER_FREQ_DRUM1,	PAR_FILTER_TYPE_DRUM1,	PAR_RESO_DRUM1,		PAR_FILTER_DRIVE_1,	
		},
		//filter
	...
	//page 6 - Voice 6 - HH (FM)
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ,	TEXT_SKIP,TEXT_PAT_SCALE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_TRANS6_WAVE,		PAR_TRANS6_VOL,			PAR_TRANS6_FREQ,		PAR_NONE,PAR_TRACK_SCALE,PAR_NONE,PAR_NONE,PAR_NONE	
			//TEXT_FILTER_F,			TEXT_FILTER_TYPE,		TEXT_FILTER_RESO,	TEXT_FILTER_DRIVE,		
			//PAR_FILTER_FREQ_DRUM1,	PAR_FILTER_TYPE_DRUM1,	PAR_RESO_DRUM1,		PAR_FILTER_DRIVE_1,	
		},
		//filter
	...
	// MENU_MIDI_PAGE - hold shift and load/save. do it again to access 5-8, and again to access others
	{
		...
		{ // -- AS GMENU 2nd sub page of global settings
			TEXT_SCREENSAVER_ON_OFF, TEXT_BAR_RESET_MODE, TEXT_SEQ_PC_TIME, TEXT_TRIGGER_IN_PPQ, TEXT_TRIGGER_OUT1_PPQ,TEXT_TRIGGER_OUT2_PPQ,TEXT_TRIGGER_GATE_MODE,TEXT_LOAD_PERF_ON_BANK,
			PAR_SCREENSAVER_ON_OFF,  PAR_BAR_RESET_MODE, PAR_SEQ_PC_TIME, PAR_PRESCALER_CLOCK_IN, PAR_PRESCALER_CLOCK_OUT1,PAR_PRESCALER_CLOCK_OUT2,PAR_TRIG_GATE_MODE,PAR_LOAD_PERF_ON_BANK
		},{ // --AS GMENU can expand into all these too
			TEXT_BUT_SHIFT_MODE,TEXT_SKIP_FIRST_ROLL,TEXT_FILE_LOAD_FAST,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_BUT_SHIFT_MODE,PAR_SKIP_FIRST_ROLL,PAR_FILE_LOAD_FAST,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
	...
	{
		{		
		TEXT_MAC1,  TEXT_MAC2,  TEXT_X_FADE,TEXT_SAMPLE_RATE,        TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_ROLL_NOTE,	TEXT_ROLL_VELOCITY,
		PAR_MAC1,   PAR_MAC2,   PAR_MORPH,  PAR_VOICE_DECIMATION_ALL,PAR_SHUFFLE,	PAR_ROLL,         PAR_ROLL_NOTE,	   PAR_ROLL_VELOCITY
		},{		
		TEXT_MAC1_DST1,TEXT_MAC1_DST1_AMT,  TEXT_MAC1_DST2,TEXT_MAC1_DST2_AMT,  TEXT_MAC2_DST1,TEXT_MAC2_DST1_AMT,  TEXT_MAC2_DST2,TEXT_MAC2_DST2_AMT,
		PAR_MAC1_DST1, PAR_MAC1_DST1_AMT,   PAR_MAC1_DST2, PAR_MAC1_DST2_AMT,   PAR_MAC2_DST1, PAR_MAC2_DST1_AMT,   PAR_MAC2_DST2, PAR_MAC2_DST2_AMT
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
	...
	*/
	...
	{
		{
			TEXT_NUM_STEPS,	TEXT_PAT_LENGTH,	TEXT_ROTATION,	TEXT_SUBSTEP_ROTATION,	TEXT_EMPTY,	TEXT_EMPTY,	TEXT_EMPTY,TEXT_EMPTY,
			PAR_EUKLID_STEPS,	PAR_EUKLID_LENGTH,	PAR_EUKLID_ROTATION,	PAR_EUKLID_SUBSTEP_ROTATION,		PAR_NONE, PAR_NONE,PAR_NONE,PAR_NONE
		}		
	},
	...
	{
		{
			TEXT_PATTERN_BEAT, TEXT_PATTERN_NEXT,	TEXT_TRANSPOSE,	TEXT_TRANSPOSE_ON_OFF, TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_PATTERN_BEAT,	PAR_PATTERN_NEXT,	PAR_TRANSPOSE,	PAR_TRANSPOSE_ON_OFF, PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		}		
	},
	//---------------- RECORDING_PAGE ------------------------------
	{
		{
			TEXT_AUTOMATION_TRACK,	TEXT_QUANTISATION,	TEXT_ROLL_MODE, TEXT_EMPTY, TEXT_EMPTY,	TEXT_EMPTY,	TEXT_EMPTY,	TEXT_EMPTY,
			PAR_AUTOM_TRACK,		PAR_QUANTISATION,	PAR_ROLL_MODE,	PAR_NONE,	PAR_NONE,	PAR_NONE,	PAR_NONE,	PAR_NONE
		}	
