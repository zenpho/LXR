...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	{
    { // --MRKR
      TEXT_SAMPLE_RATE, TEXT_SHUFFLE, TEXT_EMPTY, TEXT_EMPTY,
      TEXT_ROLL_SPEED, TEXT_ROLL_NOTE, TEXT_ROLL_VELOCITY, TEXT_SKIP,
      PAR_VOICE_DECIMATION_ALL, PAR_SHUFFLE, PAR_NONE, PAR_NONE,
      PAR_ROLL, PAR_ROLL_NOTE, PAR_ROLL_VELOCITY, PAR_NONE
    },{
		  TEXT_VOLUME,TEXT_VOLUME,TEXT_VOLUME,TEXT_EMPTY,TEXT_EMPTY,TEXT_VOLUME,TEXT_VOLUME,TEXT_VOLUME,
      PAR_VOL1,PAR_VOL2,PAR_VOL3,PAR_NONE,PAR_NONE,PAR_VOL4,PAR_VOL5,PAR_VOL6
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
