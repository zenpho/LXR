...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	...
	{
		{		
		TEXT_MAC1,  TEXT_MAC2,  TEXT_X_FADE,TEXT_SAMPLE_RATE,        TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_SHUFFLE,	TEXT_ROLL_SPEED,
		PAR_MAC1,   PAR_MAC2,   PAR_MORPH,  PAR_VOICE_DECIMATION_ALL,PAR_SHUFFLE,	PAR_ROLL,         PAR_SHUFFLE,	PAR_ROLL
		},{		
