...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		...
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ, TEXT_SKIP, TEXT_EMPTY, TEXT_EMPTY, TEXT_EMPTY, TEXT_EMPTY,
	...
	*/
	{
		{		
			TEXT_STEP_VELOCITY,	TEXT_NOTE,		TEXT_PROBABILITY,	TEXT_PAT_TRACK_SCALE,	TEXT_PARAM_DEST,	TEXT_PARAM_VAL,	TEXT_PARAM_DEST,	TEXT_PARAM_VAL,
			PAR_STEP_VOLUME,	PAR_STEP_NOTE,	PAR_STEP_PROB,		PAR_TRACK_SCALE,	PAR_P1_DEST,		PAR_P1_VAL,		PAR_P2_DEST,		PAR_P2_VAL,
		}		
	},	
